...
// Alternate settings for other skin
...
var (
	WindowSizeX = 1920 // 1600
	WindowSizeY = 1080 // 900
...
var (
	...
	ComboScale       float64 = 1 //0.72
	ComboPosition    float64 = screenSizeY * 0.45
	ComboGap         float64 = screenSizeX * -0.005 //-0.001
	ScoreScale       float64 = 1.2                  //0.67
	JudgmentScale    float64 = 1.2                  //0.35

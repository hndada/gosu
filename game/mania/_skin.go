...
func loadSkin(skinPath string) {
	...
	for i, fname := range []string{"mania-note1.png", "mania-note2.png", "mania-noteS.png", "mania-noteSC.png"} {
		...
		if skin.note[i], err = game.LoadImage(path); err != nil {
	...
	// if skin.lnHead[0], ok = graphics.LoadImage0(path); !ok {
	// 	skin.lnHead[0] = defaultSkin.lnHead[0]
	// }
	// filename =
	// 	path = filepath.Join(skinPath, filename)
	// if skin.lnHead[1], ok = graphics.LoadImage0(path); !ok {
	// 	skin.lnHead[1] = defaultSkin.lnHead[1]
	// }
	// filename =
	// 	path = filepath.Join(skinPath, filename)
	// if skin.lnHead[2], ok = graphics.LoadImage0(path); !ok {
	// 	skin.lnHead[2] = defaultSkin.lnHead[2]
	// }
	// filename =
	// 	path = filepath.Join(skinPath, filename)
	// if skin.lnHead[3], ok = graphics.LoadImage0(path); !ok {
	...
	path = filepath.Join(skinPath, filename)
	if skin.lnBody[0][0], err = game.LoadImage(path); err != nil {
		skin.lnBody[0][0] = defaultSkin.lnBody[0][0]
	}
	filename = "mania-note2L-0.png"
	path = filepath.Join(skinPath, filename)
	if skin.lnBody[1][0], err = game.LoadImage(path); err != nil {
		skin.lnBody[1][0] = defaultSkin.lnBody[1][0]
	}
	filename = "mania-noteSL-0.png"
	path = filepath.Join(skinPath, filename)
	if skin.lnBody[2][0], err = game.LoadImage(path); err != nil {
		skin.lnBody[2][0] = defaultSkin.lnBody[2][0]
	}
	filename = "mania-noteSCL-0.png"
	path = filepath.Join(skinPath, filename)
	if skin.lnBody[3][0], err = game.LoadImage(path); err != nil {
